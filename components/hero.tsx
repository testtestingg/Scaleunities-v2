  ...
  return (
    <section className="pt-32 pb-12 px-6">
      <div className="container mx-auto max-w-5xl">
        ...
        >
          Expert IT solutions tailored to your needs. We specialize in building modern websites, mobile apps, and custom
        ...
        >
          <span className="text-muted-foreground">We build</span>
          <TypingText className="font-semibold text-[#6B21A8]" />
        </motion.div>
